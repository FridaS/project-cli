...
exports.validatePassword = exports.findKeyByValue = exports.getUrlParams = exports.stringToObject = exports.textPxWidth = exports.randomColor = exports.arrFlatten = exports.clone = exports.typeOf = exports.length = exports.substr = void 0;
/**
...
function textPxWidth(text, font = 'normal 14px sans-serif') {
...
exports.textPxWidth = textPxWidth;
/**
 * 按指定分隔符将字符串转变为键值对对象
 * @param str，目标字符串
 ...
 * @return {Object}
 */
function stringToObject(str, separate1, separate2) {
 ...
 */
function getUrlParams(url, key, all) {
    if (!url) {
        return null;
    }
 ...
 */
function findKeyByValue(data, value, compare = (a, b) => a === b) {
