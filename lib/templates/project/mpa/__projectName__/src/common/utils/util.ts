 ...
 */
export function getUrlParams(url: string, key: string, all?: false): null | string 
export function getUrlParams(url: string, key: string, all: true): null | { [key: string]: string; } 
export function getUrlParams(url: string, key: string, all?: boolean) {
  if (!url) {
    return null;
  }
