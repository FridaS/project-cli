<template>
    <div class="account-form">
        ...
        <h1 style="font-size: 28px;padding:30px 0 50px;">多中心智能医学信息技术平台</h1>
        <el-form ref="form" class="account-form-form" label-width="95px" :rules="rules" :model="formData">
            <template v-if="!isResetPwd">
                <el-form-item label="姓名" prop="name">
                    <el-input placeholder="请输入真实姓名" v-model="formData.name" clearable></el-input>
                </el-form-item>
                <el-form-item label="单位" prop="organization">
                    <el-select placeholder="请选择单位" value-key="organizationCode" v-model="formData.organization">
                        <el-option 
                ...
                <el-form-item label="部门" prop="department">
                    <el-select placeholder="请选择部门" value-key="DEPARTMENTCODE" v-model="formData.department">
                        <el-option
                            v-for="item in departments"
                            :key="item.DEPARTMENTCODE"
                            :value="item"
                            :label="item.NAME"
                            :disabled="Number(item.disable) === 1"></el-option>
                    </el-select>
                    <el-tooltip content="仅提供开放合作的部门，如有需要请联系院方管理员。" placement="right">
                        <i class="account-form-icon el-icon-info"></i>
                    </el-tooltip>
                </el-form-item>
                <el-form-item label="手机号码" prop="phone">
                    <el-input placeholder="请输入手机号码" v-model.number="formData.phone" clearable></el-input>
                </el-form-item>
            </template>
            <el-form-item label="邮箱" prop="email">
                <el-input placeholder="请输入邮箱地址" v-model="formData.email" clearable></el-input>
            </el-form-item>
            <el-form-item label="图形验证码" prop="verifyCode" size="medium">
                <el-input 
                    v-model="formData.verifyCode"
                    placeholder="请输入图形验证码"
                    clearable>
                </el-input>
                <div class="verify-box" @click.stop="changeCode()">
                    <draw-verify-code :identifyCode="verifyCode"></draw-verify-code>
                </div>
            </el-form-item>
            <el-form-item label="邮箱验证码" prop="emailCode" size="medium">
                <el-input 
                    ...
                    <span 
                        ...
                        @click="sendEmail">{{buttoncotent}}</span>
                </el-input>
            </el-form-item>
            <el-form-item :label="`输入${isResetPwd ? '新': ''}密码`" prop="passWord" size="medium">
                <el-tooltip placement="right" :disabled="!showtip">
                    <div slot="content">
                        <ol>
                            <li>• 长度为8~14个字符</li>
            ...
            <el-form-item :label="`确认${isResetPwd ? '新': ''}密码`" prop="checkPassWord" size="medium">
                <el-input 
                    type="password"
